...
export const EmailSpec = Joi.object()
  .keys({
...
export const UserCredentialsSpec = EmailSpec.concat(PasswordSpec).label("UserCredentialsSpec");
...
export const NewLocationSpec = Joi.object()
  .keys({
...
export const VoteSpec = Joi.object()
  .keys({
    userId: IdSpec,
...
export const BasePhotoSpec = Joi.object()
  .keys({
